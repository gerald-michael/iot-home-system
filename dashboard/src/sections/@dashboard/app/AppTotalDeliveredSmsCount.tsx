...
export default function AppTotalDeliveredSmsCount() {
  const { data } = useSWR(`${HOST_URL}sms/total_delivered_sms/`, fetcher)

  return (
    <RootStyle>
      <IconWrapperStyle>
        <Iconify icon="arcticons:sms-backup" width={24} height={24} />
      </IconWrapperStyle>
